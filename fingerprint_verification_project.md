...
- [x] Complete `README.md` with setup instructions, usage, and sample output
- [x] Document API endpoints (already auto-generated by FastAPI)
- [x] Write a concise project report (problem, approach, results, limitations)
- [x] Add demo GIF or screenshots to README
- [-] Tag final release on GitHub (`v1.0.0`) - SKIPPED

---

## 🔮 Future Scope (Containerisation & Deployment)
